...
function template_main()
{
	...
	while ($message = $context['get_message']())
	{
		...
		// Show a icon to report post
			echo '
			<div class="reporticon"><a href="', $scripturl, '?action=reporttm;topic=', $context['current_topic'], '.', $message['counter'], ';msg=', $message['id'], '"><img src="', $settings['images_url'], '/report.png" alt="', $txt['report_to_mod'], '" title="', $txt['report_to_mod'], '" /></a></div>';
		
			// Is this user allowed to modify this member's karma?
			if (!$message['member']['is_guest'] && $message['member']['karma']['allow'])
				echo '
						<br />
						<div class="karmaoptions">
							<a href="', $scripturl, '?action=modifykarma;sa=applaud;uid=', $message['member']['id'], ';topic=', $context['current_topic'], '.' . $context['start'], ';m=', $message['id'], ';', $context['session_var'], '=', $context['session_id'], '"><img src="', $settings['images_url'], '/theme/thumb_up.png" alt="', $modSettings['karmaApplaudLabel'], '" /></a>&nbsp;
							<a href="', $scripturl, '?action=modifykarma;sa=smite;uid=', $message['member']['id'], ';topic=', $context['current_topic'], '.', $context['start'], ';m=', $message['id'], ';', $context['session_var'], '=', $context['session_id'], '"><img src="', $settings['images_url'], '/theme/thumb_down.png" alt="', $modSettings['karmaSmiteLabel'], '" /></a>
						</div>';
		echo '
			</div>
			</div>
		...
		if ($settings['show_modify'] && !empty($message['modified']['name']))
			echo '
							<span class="lasteditp">&nbsp;-&nbsp;<em>', $txt['last_edit'], ': ', $message['modified']['time'], ' ', $txt['by'], ' ', $message['modified']['name'], '</em></span>';
						echo '
				</h5>';
		echo '
		...
		{
			echo '
							<div id="msg_', $message['id'], '_footer" class="smalltext">
