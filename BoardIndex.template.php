		...
		echo '
			...
			foreach ($category['boards'] as $board)
			{
				...
				<tr id="board_', $board['id'], '" class="windowbg">
					<td class="icon td-boards td-first"', !empty($board['children']) ? ' rowspan="2"' : '', '>
				...
				// Show some basic information about the number of posts, etc.
					...
					<td class="stats td-boards">';
					if ($board['is_redirect']) {
					echo '
						<div class="statsf"><span>', $board['is_redirect'], '</span><br /><strong>', $txt['redirects'], '</strong></div>';
					}
					else {
					echo '
						<div class="statsf"><span>', $board['topics'], '</span><br /><strong>', $txt['topics'], '</strong></div>
						<div class="statsf"><span>', $board['posts'], '</span><br /><strong>', $txt['posts'], '</strong></div>';
					}
					echo '
					</td>
				...
				if (!empty($board['children']))
				{
					...
					<tr id="board_', $board['id'], '_children" class="windowbg2">
						<td colspan="3" class="children td-children">
							<span class="spoiler">', implode(', ', $children), '</span>
						</td>
					</tr>';
				}
			}
...
function template_info_center()
{
	...
	{
		echo '
			<td width="50%" valign="top"><div class="title_barIC">
				<h4 class="titlebg">
		...
		elseif (!empty($context['latest_posts']))
		{
			...
			foreach ($context['latest_posts'] as $post)
				echo '
				<div class="box">
					<span class="link">', $post['link'], '</span><br />
	...
	if ($settings['show_stats_index'])
	{
		echo '
			...
			<p>
				...
				<a href="' . $scripturl . '?action=stats">' . $txt['more_stats'] . '</a>' : '', '<br /><br />
				<span class="statsnumbers">', $context['common_stats']['total_posts'], '</span> ', $txt['posts_made'], '&nbsp;--&raquo;&nbsp;<span class="statsnumbers">', $context['common_stats']['total_topics'], '</span> ', $txt['topics'], '&nbsp;--&raquo;&nbsp;<span class="statsnumbers">', $context['common_stats']['total_members'], '</span> ', $txt['members'], '
			</p>
			</div>';
	}
