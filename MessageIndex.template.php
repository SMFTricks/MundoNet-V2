	...
	<div class="tborder childboards" id="board_', $context['current_board'], '_childboards">
		...
		foreach ($context['boards'] as $board)
		{
			...
			if (!empty($board['children']))
			{
				...
				echo '
				<tr id="board_', $board['id'], '_children" class="windowbg2"><td colspan="3" class="children td-children"><span class="spoiler">', implode(', ', $children), '</span></td></tr>';
			}
		}
		echo '
				</tbody>
